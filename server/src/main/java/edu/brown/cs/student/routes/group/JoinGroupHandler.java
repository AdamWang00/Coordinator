...
/**
 * Class that handles joining a group.
 */
public class JoinGroupHandler implements Route {
  ...
  public Object handle(Request request, Response response) throws Exception {
    try {
      ...
      // join group
      Coordinator.joinGroup(username, groupId);

      //Create an immutable map for the response
      Map<String, Object> responseMap = ImmutableMap.of("message", "added");
